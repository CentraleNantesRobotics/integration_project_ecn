...
public:
    //PID_controller(double Kp1, double Ki1, double Kd1, double Kp2, double Ki2, double Kd2) : gains{{Kp1,Ki1,Kd1},{Kp2,Ki2,Kd2}}{
    PID_controller(){
        ...
        trajSubscriber = nh.subscribe(trajTopic, 1, &PID_controller::callback, this);
    }
